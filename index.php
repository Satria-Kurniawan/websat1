...
<body>
    <div class="container">
        ...
        <!--<div class="top-nav">
                <a href="#" style="padding-left: 10px; color: black;">HOME</a>
                <a href="#" style="padding-left: 20px; color: black;">SAMSUNG</a>
                <a href="#" style="padding-left: 20px; color: black;">XIAOMI</a>
                <a href="#" style="padding-left: 20px; color: black;">REALME</a>
                <a href="form.html" style="float: right; color: black; padding-left: 20px;">SIGN UP</a>
                <a href="#" style="float: right; color: black;">LOGIN</a>
            </div>-->
        <div class="row">
            <div class="col-sm-9">
                <div class="content-box">
                    ...
                    <p class="content-text">
                        ...
                        Galaxy Fit hadir menggunakan layar AMOLED 0,95 inci dengan resolusi sebesar 120x240 pixel.
                        Layarnya sangat nyaman untuk dilihat, warna-warna yang ditampilkan begitu jelas.
                        Kita tetap bisa melihat layar dengan jelas walaupun dibawah terik matahari.
                    </p>
                </div>
            </div>
            <div class="col-sm-3">
